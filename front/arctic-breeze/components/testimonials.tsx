...
const testimonials = [
  {
    ...
    role: "Частный дом",
    content:
      "«RD Group» установил нам новую систему кондиционирования, и мы не могли быть счастливее. Специалисты профессионалы своего дела, компетентны и завершили работу раньше срока. Наш дом никогда не был таким комфортным!",
    rating: 5,
  },
  {
    name: "Михаил",
    role: "Коммерческое помещение",
    content:
      "Мы наняли «RD Group» для установки кондиционеров в нашем новом офисном помещении. Их команда работала эффективно и с минимальными перебоями в нашей деятельности. Качество их работы превосходное, и система работает идеально.",
    rating: 5,
  },
  {
    name: "Гульнур",
    role: "Квартира в ЖК",
    content:
      "Команда была пунктуальна и вежлива. Они нашли время, чтобы объяснить наши варианты и рекомендовали систему, которая идеально соответствует нашим потребностям и бюджету. Настоятельно рекомендую их услуги!",
    rating: 4,
  },
  {
    name: "Нурлан",
    role: "Управляющий многоквартирным домом",
    content:
      "Я работал со многими компаниями HVAC на протяжении многих лет, и «RD Group» выделяется своей надежностью и опытом. Они устанавливали системы в нескольких объектах, которыми я управляю, всегда с отличными результатами.",
    rating: 5,
  },
  {
    name: "Алия",
    role: "Ресторан",
    content:
      "Когда наша старая система кондиционирования вышла из строя в разгар лета, ребята этой компании пришли на помощь. Их быстрая реакция спасла наш бизнес от потери клиентов во время жары.",
    rating: 5,
  },
]
